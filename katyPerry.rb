...
rule :program, "you're in", :statements, "then you're out"
...
rule :function_definition, "Baby you are a", :identifier, :parameter_list?, "make'em go, ah, ah", :statements, "as you shoot across the sky,y,y" do
  def evaluate
...
rule :statement, "you're yes", :statement, "then", :statements, :else_clause?, "end" do
  def evaluate
...
rule :else_clause, "you're no", :statements
...
rule :statement, "Are you ready for?", :statement, "A perfect storm", :statements, "there's no going back" do
  def evaluate
    ret = nil
